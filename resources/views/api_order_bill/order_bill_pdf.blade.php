        ...
        <table class="table-custom">
            <tr>
                <td style="width:60%;">
                    ...
                    <h2 style="font-size: 20px; color:#2d1e1e; font-weight: 400; margin-top:15px;">Order No: {{ env('ORDER_PREFIX').$order->order_number }}</h2>
                </td>
                <td style="width:40%;">
                    <h3 
                        ...
                        <h3 style="font-size: 15px;
                            ...
                            <span style="display:inline-block;">
                                @if($order->customer && $order->customer->phone)
                                 {{$order->customer->country_code_phone.' '.$order->customer->phone}}
                                @else
                                  N/A 
                                @endif
                            </span>
                        ...
                        <tr>
                            ...
                            <td>
                                <h5 style="color:#000; font-size: 16px; font-weight: 600; margin-bottom: 6px;">Sales
                                    Person:</h5>
                                <p style="color:#000; font-size: 14px;">{{$order->createdBy ? $order->createdBy->name : ""}}
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px;">{{ number_format($item->quantity * $item->piece_price ) }} </td>
                            </tr>

                            @endforeach
                            @if ($order->air_mail > 0)
                            @php
                            $airMail = $order->air_mail;
                            @endphp
                            <tr>
